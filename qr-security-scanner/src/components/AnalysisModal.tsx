...
export default function AnalysisModal({ visible, url, onClose, onAnalyze }: AnalysisModalProps) {
  if (!url) return null;
    ...
    >
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.subtitle}>Do you want to analyze this URL for security threats?</Text>

          <View style={styles.urlContainer}>
            <Ionicons name="link-outline" size={20} color={colors.textLight} style={styles.urlIcon} />
          ...
          <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity 
              ...
              activeOpacity={0.8}
            >
              <Ionicons name="analytics" size={20} color={colors.white} style={styles.btnIcon} />
